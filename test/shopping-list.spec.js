...
describe(`Shopping List Service object`, function () {
    ...
    let testItems = [
        {
            ...
            date_added: new Date('2010-01-22T16:28:32.615Z'),
            price: '9.00',
            category: 'Main'
        },
        {
            ...
            date_added: new Date('2011-05-22T16:28:32.615Z'),
            price: '11.00',
            category: 'Snack'
        },
        {
            ...
            date_added: new Date('2012-12-22T16:28:32.615Z'),
            price: '7.00',
            category: 'Lunch'
        },
        {
            ...
            date_added: new Date('2015-12-22T16:28:32.615Z'),
            price: '4.99',
            category: 'Breakfast'
        },
    ];
    ...
    context(`Given 'shopping_list' has data`, () => {
        ...
        it(`getById() resolves an item by id from 'shopping_list' table`, () => {
            const idToRecieve = 3;
            const thirdItem = testItems[idToRecieve - 1];
            return ShoppingListService.getById(db, idToRecieve)
                .then(actual => {
        ...
        it(`deleteItem() removes an item by id from 'shopping_list' table`, () => {
            const idDelete = 3;
            return ShoppingListService.deleteItem(db, idDelete)
